...
public struct CodeTileView: View {
  ...
  private func color(for role: CodeTilePayload.Region.Role) -> Color {
    switch role {
    case .keyword:    return LeahPalette.champagneGold
    case .identifier: return LeahPalette.ivory
    case .op:         return LeahPalette.textMuted
    case .whitespace: return LeahPalette.ivory
    }
  }
